...
@pytest.mark.math
@pytest.mark.parametrize("S, X, T, r, sigma, expected", [
    (100.0, 105.0, 1.0, 0.05, 0.2, 7.90),  # in-the money put
    (50.0, 50.0, 0.5, 0.03, 0.25, 3.14),   # at-the-money put
    (120.0, 100.0, 2.0, 0.04, 0.15, 1.16) # out-of-the-money put
])
